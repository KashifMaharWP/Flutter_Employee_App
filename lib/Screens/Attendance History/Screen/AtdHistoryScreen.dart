...
import 'package:employee_management_app/Screens/Attendance%20History/Provider/HistoryProvider.dart';
...
/*void _pickMonth() async {
  ...
  Widget build(BuildContext context) {
    int SelectedMonthNumber=_currentMonth.month;
                      ...
                      InkWell(
                          onTap: () async {
                            showMonthPicker(
                              ...
                              initialSelectedMonth: SelectedMonthNumber,
                              initialSelectedYear: currentYear,
                              firstEnabledMonth: 1,
                              lastEnabledMonth: currentMonthNumber,
              ...
              Expanded(
                child: FutureBuilder(
                  future: Provider.of<HistoryProvider>(context, listen: false)
                      .GetAttendanceData(_currentMonthfilter.toString(),context),
